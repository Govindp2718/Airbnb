...
def main():
  ...
  Min_price = st.number_input('Min Price', (df.price.min()), (df.price.max()), 10.0 , step =10.0)
  Max_price = st.number_input('Max Price', (df.price.min()), (df.price.max()), 5000.0, step=10.0)
